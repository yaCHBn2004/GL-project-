  ...
  return (
    <div id="l" className="flex justify-center items-center h-screen relative " >
      ...
      <div className="bg-[#E0E2E9] h-[80%] w-[65%] flex flex-col items-center gap-4 rounded-[10px] " >
       ...
       <div className="flex flex-row gap-[5%] items-center justify-center"> <button type="submit" className="font-Poppins text-[#FFFFFF] bg-[#2C2C2C] p-2 font-bold rounded-[10px] mt-9 mb-6 w-36" >Login</button>        <button type="submit" className="font-Poppins text-[#2C2C2C] bg-[#ffffff] p-2 font-bold rounded-[10px] mt-9 mb-6 w-36 flex flex-row gap-2" ><img src={google} className='w-[25px]'/><p>Google</p></button></div>
          <div className='flex flex-row gap-[2%] w-[60%] justify-center items-center'>          <div className=" h-[2px] bg-[#2C2C2C]  w-[35%] "></div><p className='f6'>or </p>          <div className=" h-[2px] bg-[#2C2C2C]  w-[35%] "></div></div>
