...
function HomeB() {
    return (
     <div className='flex flex-row text-center justify-evenly my-[2vh] h-[70vh] text-[#fff]'>
        <div className=" rounded-[5px] p-2 h-[80%] w-[30%] bg-[#25323B] flex flex-col items-center justify-center gap-[2%]  ">
